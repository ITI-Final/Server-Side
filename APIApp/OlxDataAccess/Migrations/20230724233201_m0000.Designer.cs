...
namespace OlxDataAccess.Migrations
{
    ...
    [Migration("20230724233201_m0000")]
    partial class m0000
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Admin_Permission", b =>
                {
                    ...
                    b.HasKey("Admin_Id", "Permission_Id")
                        .HasName("PK_admin_permission");

                    b.HasIndex(new[] { "Permission_Id" }, "IX_Admin_Permission_Permission");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Admin", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "NonClusteredIndex-20230716-201110");

                    b.HasIndex(new[] { "Email" }, "nonclusteredEmail");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Category", b =>
                {
                    ...
                    b.HasIndex(new[] { "Admin_Id" }, "IX_Category_Admin_Id");

                    b.HasIndex(new[] { "Parent_Id" }, "IX_Category_Parent_Id");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Chat", b =>
                {
                    ...
                    b.HasIndex(new[] { "Sender_ID" }, "IX_Chat_User_One");

                    b.HasIndex(new[] { "Receiver_ID" }, "IX_Chat_User_Two");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Choice", b =>
                {
                    ...
                    b.HasIndex(new[] { "Field_Id" }, "IX_Choice_Field_Id");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.City", b =>
                {
                    ...
                    b.HasIndex(new[] { "Governorate_Id" }, "IX_Cities_Governorate_Id");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Favorite", b =>
                {
                    ...
                    b.HasIndex(new[] { "Post_Id" }, "IX_Favorite_Post_Id");

                    b.HasIndex(new[] { "User_Id" }, "IX_Favorite_User_Id");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Field", b =>
                {
                    ...
                    b.HasIndex(new[] { "Cat_Id" }, "IX_Field_Cat_Id");

                    b.HasIndex(new[] { "Parent_Id" }, "IX_Field_Parent_Id");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Field_Role", b =>
                {
                    ...
                    b.HasIndex(new[] { "Field_Id" }, "IX_Field_Role_Field_Id");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Post", b =>
                {
                    ...
                    b.HasIndex(new[] { "Cat_Id" }, "IX_Post_Cat_Id");

                    b.HasIndex(new[] { "Post_Location" }, "IX_Post_Post_Location");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.Post_Image", b =>
                {
                    ...
                    b.HasIndex(new[] { "Post_Id" }, "IX_Post_Image_Post_Id");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.User_Connection", b =>
                {
                    b.Property<int>("User_ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OlxDataAccess.Models.User", b =>
                {
                    b.Navigation("Chat_MessageReceivers");

                    b.Navigation("Chat_MessageSenders");
